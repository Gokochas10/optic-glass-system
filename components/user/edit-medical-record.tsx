...
import { editMedicalRecord } from "@/actions/editMedicalRecord";
...
const EditMedicalRecord: React.FC<EditMedicalRecordProps> = ({medicalRecord,medicalRecordId}) => {
  ...
  return (
    <div className="w-full max-w-[1200px]">
      <Alert>
        <h1 className="flex justify-center mb-4 text-4xl">Editar Registro Médico de {clientData.fullName}</h1>
